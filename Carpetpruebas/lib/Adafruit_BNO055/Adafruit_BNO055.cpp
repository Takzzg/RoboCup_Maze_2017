...
*/
/**************************************************************************/
Adafruit_BNO055::Adafruit_BNO055(int32_t sensorID, uint8_t address, I2C *_i2c)
{
  _sensorID = sensorID;
  _address = (address<<1);
  this->_i2c = _i2c ;
...
{
  _mode = mode;
  write8(BNO055_OPR_MODE_ADDR,(char)_mode);
  wait_ms(30);
}
...
*/
  ...
  _i2c->write(this->_address,write_value,2,false);
  return true;
}
...
uint8_t Adafruit_BNO055::read8(adafruit_bno055_reg_t reg )
{
 ...
 /*
  ...
  #endif
  */
  _i2c->write(this->_address,&wreg,1,true);
  _i2c->read(this->_address,&value,1,false);
...
bool Adafruit_BNO055::readLen(adafruit_bno055_reg_t reg, char *buffer, uint8_t len)
{
  ...
  _i2c->write(this->_address,&wreg,1,true);
  _i2c->read(this->_address,buffer,len,false);
